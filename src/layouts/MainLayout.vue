  ...
  <q-layout view="lHh Lpr lFf">
    <q-header>
      ...
      <div class="q-px-lg q-pt-lg q-mb-md">
        <div class="text-h4">Today's Main Focus</div>
        <div class="text-subtitle1">{{ todaysDate }}</div>
      </div>
      <q-img src="../assets/banner.png" class="header-image absolute-top" />
    </q-header>
...
export default defineComponent({
  ...
  setup() {
    ...
    const todaysDate = computed(() =>
      date.formatDate(Date.now(), "dddd D MMMM")
    );
